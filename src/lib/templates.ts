...
export const adminEmailTemplate = (data: FormType) => `
  <div style="font-family: Arial, sans-serif; padding: 20px; background: #f7f9fb;">
    <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 8px;">
      <img src="https://www.jzdlabs.com/_next/image?url=%2Fimages%2Flogo-t.png&w=640&q=75" alt="JZ Digital Labs LLC" style="width:180px; margin-bottom: 20px;" />
      ...
      <p style="margin-top: 30px; font-size: 14px; color: #999;">
        JZ Digital Labs LLC | New Website Inquiry
      </p>
    </div>
  </div>
`;
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px; background: #f7f9fb;">
    <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 8px;">
      ...
      <p style="font-size: 15px;">
        ...
        Thank you for reaching out to <strong>JZ Digital Labs LLC</strong>.
      ...
      <p style="margin-top: 30px; font-size: 14px; color: #999;">
        ...
        <br />
        <a href="https://jzdlabs.com" style="color:#7846FF;">Visit our website</a>
      </p>
    </div>
  </div>
`;
